      ...
      <div className="w-full">
        <Card className="bg-white border-gray-200 shadow-sm">
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="flex flex-col h-16">
              <Label className="text-gray-700 font-medium text-sm leading-tight mb-2">Consumption of the cleaner to clean the pump [L]</Label>
              <div className="flex items-center mt-auto">
                <Input
                  value={results.cleanerConsumption.toFixed(4)}
                  readOnly
                  className="bg-white border-green-accent-300 text-gray-900 font-medium"
                />
                <span className="ml-2 text-gray-700 font-medium">L</span>
            ...
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Consumption for:</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-green-accent-50 p-4 rounded-lg border border-green-accent-200">
                  <div className="flex flex-col h-16">
                    <Label className="text-gray-700 font-medium text-xs leading-tight mb-2">Filling the building material with resin</Label>
                    <div className="flex items-center mt-auto">
                      <Input
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-green-accent-100 p-4 rounded-lg border border-green-accent-300">
                  <div className="flex flex-col h-16">
                    <Label className="text-gray-700 font-medium text-xs leading-tight mb-2">PI-CLEANER (pump cleaner) CONSUMPTION PROGRESS [L]</Label>
                    <Input
